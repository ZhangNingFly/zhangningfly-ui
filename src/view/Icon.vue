<template>
   <h3>图标</h3>
  <div class="content">
    <Block-code title="使用方法" :code="code" height="182px">
      <template #source>
      ...
      <template #description>
        <p style="font-size: 14px;color: #5e6d82">
          直接通过设置类名为 iconfont-iconName 来使用即可
        </p>
      </template>
    </Block-code>
      <p style="margin: 55px 0 20px;font-weight: 400;color: #1f2f3d;font-size: 22px;">
        图标集合
      </p>
...
// import '../../public/iconfont/cube.css'
export default {
  setup () {
    return {
       code:
